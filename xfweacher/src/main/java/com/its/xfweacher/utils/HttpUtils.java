...
public class HttpUtils {
	...
	public static String getURl(String location,String ak) {

		String url = "http://api.map.baidu.com/telematics/v3/weather?location="
				+ location + "&output=json&ak="+ak;//B95329fb7fdda1e32ba3e3a245193146
		return url;
	}
	...
	public static List<Province> getProvinces(Context context)
		...
		InputStream in = context.getResources().openRawResource(R.raw.citys_weather);
	...
	public static List<Map<String, Object>> toListMap(Result r) {
		//��result�л�ȡ��������Ϣ������imageת��Ϊbitmap����list
		return null;
	}
}
