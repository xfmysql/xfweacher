...
public class ChapActivity extends Activity implements OnClickListener, FlipperLayout.TouchListener {
	private static final String TAG = ChapActivity.class.getName();
	private String text = "";
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			View recoverView = LayoutInflater.from(ChapActivity.this).inflate(R.layout.view_new, null);
			View view1 = LayoutInflater.from(ChapActivity.this).inflate(R.layout.view_new, null);
			View view2 = LayoutInflater.from(ChapActivity.this).inflate(R.layout.view_new, null);
			rootLayout.initFlipperViews(ChapActivity.this, view2, view1, recoverView);
